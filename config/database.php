...
function sendSecurityHeaders() {
    if (!headers_sent()) {
        ...
        // CSP: allow self + CDN fonts + Chart.js + Twilio (microphone needed for VoIP) + Google Tag Manager, Google Analytics, and Meta Pixel
        header("Content-Security-Policy: default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://media.twiliocdn.com https://*.twilio.com https://www.googletagmanager.com https://*.google-analytics.com https://connect.facebook.net https://*.gateway.mastercard.com https://gateway.mastercard.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; img-src 'self' data: blob: https://www.googletagmanager.com https://*.google-analytics.com https://*.google.com https://*.doubleclick.net https://www.facebook.com https://*.gateway.mastercard.com https://gateway.mastercard.com; connect-src 'self' https://*.twilio.com wss://*.twilio.com https://eventgw.twilio.com https://media.twiliocdn.com https://chunderw-vpc-gll.twilio.com https://chunderw-vpc-gll-au1.twilio.com https://chunderw-vpc-gll-br1.twilio.com https://chunderw-vpc-gll-ie1.twilio.com https://chunderw-vpc-gll-jp1.twilio.com https://chunderw-vpc-gll-sg1.twilio.com https://chunderw-vpc-gll-us1.twilio.com https://chunderw-vpc-gll-us2.twilio.com https://www.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com https://*.stats.g.doubleclick.net https://www.facebook.com https://*.gateway.mastercard.com https://gateway.mastercard.com; frame-src 'self' https://www.googletagmanager.com https://*.gateway.mastercard.com https://gateway.mastercard.com; media-src 'self' blob:;");
    }
}
