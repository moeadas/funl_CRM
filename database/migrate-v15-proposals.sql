-- Migration v15: Create proposals table
-- Extracted from database/create_proposals_table.php so it can run in the
-- standard SQL install chain (the PHP script was never called by any installer).
