...
<?php require_once __DIR__ . '/preloader.php'; ?>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item nav-tab-pipeline">
            ...
            <li class="nav-item nav-tab-proposals">
            ...
            <li class="nav-item nav-tab-export">
            ...
            <li class="nav-item nav-tab-email-campaigns">
            ...
            <li class="nav-item nav-tab-email-templates">
            ...
            <li class="nav-item nav-tab-email-lists">
            ...
            <li class="nav-item nav-tab-webforms">
            ...
            <li class="nav-item nav-tab-voip-dashboard">
            ...
            <li class="nav-item nav-tab-whatsapp-dashboard">
            ...
            <li class="nav-item nav-tab-documents">
            ...
            <li class="nav-item">
                <a href="/pages/mini-guide.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'mini-guide.php' ? 'active' : ''; ?>">
