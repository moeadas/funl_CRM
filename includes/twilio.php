<?php
/**
 * White Label CRM — Twilio Integration Helper
...
class TwilioHelper {
     ...
     */
    const WA_TEMPLATES = [
        'notification'         => 'HXaba2d863dba9c67faffba804c0fb92fc', // vg_notification_v2: Hello {{1}}, … Your Company … {{2}} — Please reply …
    ...
    public static function notifyLeadAssignment($assignedUserId, $leadName, $leadId, $assignedByName = '') {
        try {
            ...
            $bodyForLog = "Hi $userName, a new lead has been assigned to you: $leadName. Assigned by: $assigner. Please follow up as soon as possible. - White Label CRM";
